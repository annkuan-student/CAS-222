...
<html lang="zxx">
   ...
   <body>
      ...
      <main>
          <div id="aboutevent">
              <p>The Annual Ace in the Hole Multisport Weekend is a legendary event in the Oregon triathlon and running community that takes place March 27th and 28th, 2021. It has become a traditional destination race for athletes from across the nation.
              <br>
                  <br>
          ...
          <div class="registerbutton"><button><a href="../register/index.php">Register Now!</a></button></div>
          <div class="coursedetails">
              <h1>Course Details</h1>
              <p><b>Water temperature</b> is expected to be between 62 & 66 degrees. The temperature will be taken on Friday and the morning of the race. Wetsuits are recommended.</p>
              ...
              <p><b>OLYMPIC RUN - 10K | </b> A mostly flat loop course on widely paved bike paths that traverse through and around this beautiful and scenic destination resort (one hill total with a minimal elevation gain).</p>
               ...
               <p><b>Try-A-Tri - 10K | </b> A mostly flat loop course on widely paved bike paths that traverse through and around this beautiful and scenic destination resort (one hill total with a minimal elevation gain).</p>
              
               <p><b>Half Marathon COURSE: Half-Marathon (13.1-miles) | </b>Half-Marathon event starts and finishes in the Athletes Village to the cheers of the enthusiastic crowd. Once finished, runners can enjoy the finish line festivities, including the Sports & Fitness Expo and live entertainment. Post-race refreshments will be provided and the Awards Ceremony for the Half-Marathon will begin once the results have been certified</p>
          ...
          <button class="accordion"><h1>FAQ</h1></button>
          <div class="panel">
          ...
          <p><b>What are the Rules?</b> We currently adhere to the USAT Rules for Triathlon & Duathlon. Important rules include no drafting, you must wear a helmet and music is ABSOLUTELY NOT allowed during the bike for obvious safety reasons.</p>
           ...
           <button class="accordion"><h1>What to Bring</h1></button>
          <div class="panel">
          ...
          <div id="whattobring">
       <h1>What to Bring</h1>
              <p>Watch the weather closely. The show goes on no matter what the weather is doing.</p><div class="weather"><a target="_blank" href="https://www.booked.net/weather/portland-1095"><img src="https://w.bookcdn.com/weather/picture/32_1095_0_1_e74c3c_250_c0392b_ffffff_ffffff_1_2071c9_ffffff_0_6.png?scode=124&domid=w209&anc_id=40847"  alt="booked.net"/></a></div>
              <p>You must wear your chip timing piece during the entire event. You will be given a band that will hold your chip timing piece around your ankle throughout the entire event. Be sure that it is snapped tightly. Be sure to have your Chip Timing piece on before you start the race and be sure to step over the timing mats after each segment of the race. If you are wearing a wet-suit, make sure the timing piece goes under your wetsuit otherwise, you will have a very difficult time getting off your wet suit.</p>
              <p><b>Swim:</b> Wetsuits are optional for the swim but will provide buoyancy and warmth. However, many people opt for no wetsuit for a triathlon so no worries. We will provide you with a swim cap but you will want to bring your own goggles.</p>
              <p><b>Biking: </b>A biking helmet is mandatory. You will also receive 2 stickers in your package with your race number on them. The small sticker should go on the front of your helmet. The bigger sticker will wrap around your bike frame. Road or mountain bikes are acceptable. For safety reasons, be sure to have end-caps on the end of your handle-bars.</p>
              <p><b>Run:</b> You must finish the race with your bib number on the front of you. Some people choose to pin it on at the beginning of the race and have it on for the whole event so they don't have to worry about it. Others pin it on a singlet that they put on once they finish the swim before they head out for the bike. Others use an elastic racing strap that they pin their bib number to and then quickly strap it on before they leave for the run. Use whatever option feels best for you.</p>
              <p>Remember to bring a change of clothing so you can enjoy the post-event festivities.</p>
       </div>
          <div id="sponsors">
       <h1>Thank You to Our Sponsors</h1>
              <p>Portland MultiFit</p>
              <p>Oregon Trail Runners Association</p>
              <p>Runbelievable PDX Athletic Wear</p>
       </div>
      </main>
      <?php include '../includes/footer.inc.html.php'; ?>
      <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
      <script src="../style/style.js"></script>
    <script src="../style/accordion.js"></script>
   </body>
</html>